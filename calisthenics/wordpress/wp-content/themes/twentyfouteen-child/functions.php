...
function nifty_scripts()
{
     ...
     wp_enqueue_style( 'font-awesome', 'http://pccwebdesign.com/student???/css/font-awesome.min.css' );
     ...
     wp_enqueue_script('sidr-script', 'http://nomadmystic.com/CAS211W/nifty/js/jquery.sidr.min.js', array('jquery'), '1.2.0', false);
